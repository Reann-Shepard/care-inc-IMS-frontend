...
//     onManufacturerSelect: (manufacturer: { value: number; label: string; } | null) => void;
// }

// const ManufacturerFilter: React.FC<ManufacturerFilterProps> = ({ onManufacturerSelect }) => {
//     const [manufacturerOptions, setManufacturerOptions] = useState<{ value: number; label: string; }[]>([]);
...
//             >
//                 <MdOutlineFactory className="mr-2" /> Manufacturer <IoMdArrowDropdown className="ml-2" />
//             </div>
//             <ul
//                 tabIndex={0}
...
//                     <li key={manufacturer.value} onClick={() => onManufacturerSelect(manufacturer)}>
